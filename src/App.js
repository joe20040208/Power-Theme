...
const ThemeStatsPopup = ({ themeName, themes, anchorRect, onClose }) => {
  ...
  // Position popup top-aligned with the chart, to its left
  ...
  return (
    <>
      ...
      <div style={{ position:'fixed', left, top, width:MAX_W, zIndex:10000, borderRadius:10, border:'1px solid rgba(63,63,70,0.7)', boxShadow:'0 24px 64px rgba(0,0,0,0.85)', background:'#18181b', overflow:'hidden', maxHeight:`calc(100vh - ${top}px - 16px)`, overflowY:'auto' }}
